...
[Reference Tables](Reference_Tables.qmd)
...
![Course Structure](Images/0_Course_Structure.png)

:::{.callout-warning}
All the lectures are delivered *online asynchronous*
:::

- L1	[Properties of  Fluids](1_Introduction.qmd)
    - Shear stress, viscosity, density, compressibility, surface tension.

- L2	[Simple Flow Fields and Phenomena 1](1_2_Flow_Fields.qmd)
...
- L3	[Simple Flow Fields and Phenomena 2](1_3_More_Flow.qmd)
...
- L4	[Introduction to Dimensional Analysis](/Other_Notes/Engineering/Dimensional_Analysis/Buckingham_Pi.qmd)

- L5	[Fluid Statics 1](2_1_Pressure.qmd)
...
![Laboratory overview](Images/0_Laboratories.png)
...
![Assessment structure](Images/0_Assessment.png)
...
| Picture | ![Tom Bruce](Images/0_Tom_Bruce.png) |
