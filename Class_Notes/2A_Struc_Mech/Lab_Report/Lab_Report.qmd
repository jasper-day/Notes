...
The weight $W$ acting on a lever arm evokes a moment $M$ in the shaft:

\input{torsion_moment.tex}

This moment causes a torsion in the beam, which creates a deflection in the lever arm. This deflection is measured at point $P$.
